...
const realCases: AuditCase[] = [
  {
    ...
    questions: [
      { stage: "위험 평가", kicker: "IDENTIFY THE RISK", prompt: "SI 매출은 진행률로 인식되고, 총예정원가에는 미래 노무비·외주비와 계약변경 추정이 포함됩니다. 이 사실에서 가장 직접적으로 도출되는 감사위험은?", choices: ["총예정원가 추정의 오류가 진행률과 당기 매출 인식액을 왜곡할 위험", "현금 시재가 존재하지 않을 위험", "자본금 액면가가 잘못 표시될 위험"], answer: 0, explanation: "진행률 계산의 분모인 총예정원가가 달라지면 진행률과 매출 인식액도 달라집니다. 실제 감사보고서도 이러한 추정과 판단 때문에 진행률 계산을 핵심감사사항으로 선정했습니다.", basis: "2023 연결감사보고서 · KAM 선정 이유", skill: "판단력" },
      { stage: "통제 접근", kicker: "RELY OR REJECT", prompt: "진행률 관련 내부통제에 의존하는 감사접근을 계획한다면 가장 필요한 대응은?", choices: ["SI 매출 인식 프로세스·회계정책·통제를 이해하고 진행률 계산 통제의 설계와 운영 효과성을 테스트한다", "프로젝트 담당자의 구두 설명만으로 통제가 효과적이라고 판단한다", "전사 매출의 전년 대비 증감만 확인한다"], answer: 0, explanation: "감사인은 실제로 SI 매출 인식 프로세스와 내부통제를 이해하고 진행률 계산 통제의 설계·운영 효과성을 테스트했습니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "효율성" },
      { stage: "증거 설계", kicker: "MATCH THE EVIDENCE", prompt: "표본 프로젝트에서 계약금액·거래조건과 총예정원가를 동시에 검증하려면 어떤 증거 조합이 가장 직접적인가?", choices: ["프로젝트 계약서와 총예정원가 관련 증빙자료", "전사 법인카드 사용명세와 임직원 급여대장", "대표이사 확인서와 주주명부"], answer: 0, explanation: "계약서는 계약금액과 거래조건을, 총예정원가 증빙은 진행률 추정의 기초를 직접 뒷받침합니다. 이는 감사보고서에 기재된 실제 절차입니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "추정 변경", kicker: "FOLLOW THE CHANGE", prompt: "결산 전후 총예정원가가 중요하게 변경된 프로젝트가 식별됐습니다. 전문적 의구심을 가장 잘 반영한 대응은?", choices: ["변경 사유를 질문하고 관련 문서를 검사한 뒤 진행률과 매출 인식액을 다시 검토한다", "결산 후 변경이므로 당기 감사와 무관하다고 본다", "모든 변경 프로젝트의 매출을 자동으로 취소한다"], answer: 0, explanation: "감사인은 중요 변경 프로젝트의 사유와 적정성을 확인하고 보고기간 후 변경도 관련 문서와 함께 검토했습니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "보고 판단", kicker: "FORM THE OPINION", prompt: "진행률 관련 통제·계약·원가·재계산 절차에서 중요한 미수정 왜곡이 발견되지 않았습니다. 핵심감사사항과 감사의견의 관계를 올바르게 판단한 것은?", choices: ["진행률은 핵심감사사항으로 설명하되 연결재무제표에는 적정의견을 표명한다", "핵심감사사항이 존재하므로 반드시 한정의견을 낸다", "핵심감사사항을 별도의 부적정의견으로 표시한다"], answer: 0, explanation: "핵심감사사항은 별도 의견이 아닙니다. 실제 보고서도 SI 진행률을 핵심감사사항으로 설명하면서 연결재무제표에 적정의견을 표명했습니다.", basis: "2023 연결감사보고서 · KAM 및 감사의견", skill: "판단력" },
    ],
  ...
  },
  {
    ...
    questions: [
      { stage: "위험 평가", kicker: "IDENTIFY THE RISK", prompt: "영업권 321억원 중 게임 부문 현금창출단위에 256억원이 배부돼 있고 사용가치는 미래현금흐름에 좌우됩니다. 가장 유의적인 감사위험은?", choices: ["경영진의 가정과 판단으로 사용가치 및 영업권 손상 여부가 왜곡될 위험", "영업권이 현금계정으로 잘못 분류될 위험", "발행주식수가 누락될 위험"], answer: 0, explanation: "영업권 규모가 유의적이고 사용가치에 경영진의 중요한 가정과 판단이 포함되므로 손상평가가 핵심감사사항으로 선정됐습니다.", basis: "2023 연결감사보고서 · KAM 선정 이유", skill: "판단력" },
      { stage: "감사 초점", kicker: "ALLOCATE THE EFFORT", prompt: "전체 영업권 가운데 게임 부문이 약 80%를 차지합니다. 제한된 감사자원을 배분할 때 가장 타당한 판단은?", choices: ["게임 부문 현금창출단위의 사용가치와 주요 가정에 감사절차를 집중한다", "영업권 규모와 관계없이 모든 현금창출단위에 동일한 시간을 배분한다", "영업권 대신 자본금 표시만 집중 검토한다"], answer: 0, explanation: "실제 감사인도 영업권 금액이 유의적인 게임 부문 현금창출단위에 집중된 손상평가 절차를 수행했습니다.", basis: "2023 연결감사보고서 · KAM 선정 이유", skill: "효율성" },
      { stage: "모형 검증", kicker: "CHALLENGE THE MODEL", prompt: "미래현금흐름이 승인된 사업계획과 일치한다는 사실만으로 사용가치를 수용할 수 있을까요?", choices: ["아니다. 가치평가 모델과 관련 통제를 평가하고 주요 가정도 별도로 반증해야 한다", "그렇다. 승인된 사업계획이면 추가 절차는 불필요하다", "사업계획 대신 대표이사 확인서만 받으면 충분하다"], answer: 0, explanation: "감사인은 사업계획과의 일치뿐 아니라 모형의 적절성, 추정 관련 통제와 주요 가정의 합리성을 함께 평가했습니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "가정 반증", kicker: "USE CONTRADICTORY EVIDENCE", prompt: "경영진의 게임 부문 전망이 낙관적인지 판단할 때 가장 설득력 있는 감사증거 조합은?", choices: ["당기 실제성과와 전기 추정 비교 · 장기성장률과 경제·산업 예측 비교 · 할인율과 독립 계산치 비교", "당기 매출 합계와 직원 수 비교", "경영진의 낙관적 설명과 회사 홍보자료"], answer: 0, explanation: "세 비교절차는 모두 감사보고서에 기재된 실제 대응이며 경영진 가정을 내부·외부 증거로 반증합니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "결론 형성", kicker: "ASSESS THE HEADROOM", prompt: "경영진은 사용가치와 장부금액 사이에 충분한 여유가 있다고 판단했습니다. 결론의 견고성을 확인하는 데 가장 필요한 추가 판단은?", choices: ["할인율과 영구성장률 변화가 손상 결론을 뒤집는지 민감도 분석을 평가한다", "여유가 있다는 설명만으로 절차를 종료한다", "영업권 전액을 자동으로 손상 처리한다"], answer: 0, explanation: "실제 감사인은 할인율과 영구성장률 민감도 분석 결과를 평가한 뒤 연결재무제표에 적정의견을 표명했습니다.", basis: "2023 연결감사보고서 · KAM 및 감사의견", skill: "판단력" },
    ],
  ...
  },
  {
    ...
    questions: [
      { stage: "위험 평가", kicker: "ASSESS SIGNIFICANCE", prompt: "HYBE America 투자 장부금액은 자산총계의 35.1%이고 손상징후가 존재해 1,529억원의 손상차손이 인식됐습니다. 감사에서 가장 유의적으로 볼 판단은?", choices: ["회수가능가액 추정과 손상차손 인식이 합리적인지", "본사 소모품 구매가 승인됐는지", "배당금 지급일이 공휴일인지"], answer: 0, explanation: "투자 규모가 크고 회수가능가액에 미래 사업 예상과 할인율 판단이 포함되므로 손상평가가 핵심감사사항이 됐습니다.", basis: "2023 별도감사보고서 · KAM 선정 이유", skill: "판단력" },
      { stage: "통제 접근", kicker: "START WITH THE TRIGGER", prompt: "회사가 손상징후가 존재한다고 판단했습니다. 손상평가 수치에 들어가기 전에 감사인이 먼저 평가해야 할 통제는?", choices: ["경영진이 자산손상징후를 식별·검토하는 절차와 관련 통제", "본사 출입카드 발급 통제", "주주명부 변경 통제"], answer: 0, explanation: "감사인은 경영진의 자산손상징후 검토 절차와 관련 통제를 이해하고 평가했습니다.", basis: "2023 별도감사보고서 · KAM 감사대응", skill: "효율성" },
      { stage: "모형 검증", kicker: "TRACE THE FORECAST", prompt: "회수가능가액이 가치평가 모형으로 계산됐습니다. 경영진 전망을 그대로 수용하지 않기 위한 가장 적절한 절차 조합은?", choices: ["모형의 적절성을 평가하고 미래현금흐름이 승인 사업계획과 일치하는지 확인하며 주요 가정을 반증한다", "최종 계산값만 장부금액과 비교한다", "대표이사 확인서만 받고 모형은 검토하지 않는다"], answer: 0, explanation: "모형·사업계획·주요 가정을 나누어 평가하는 세 절차가 실제 감사보고서에 기재돼 있습니다.", basis: "2023 별도감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "전문가 활용", kicker: "CAN YOU RELY?", prompt: "경영진측 전문가가 회수가능가액 추정에 참여했습니다. 그 결과를 감사증거로 고려하기 전에 필요한 판단은?", choices: ["전문가의 적격성과 독립성을 평가한다", "전문가가 회사와 계약했다는 사실만 확인한다", "전문가가 참여했으므로 다른 손상절차를 모두 생략한다"], answer: 0, explanation: "감사인은 회수가능가액 추정에 참여한 경영진측 전문가의 적격성과 독립성을 실제로 평가했습니다.", basis: "2023 별도감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "보고 판단", kicker: "FORM THE OPINION", prompt: "손상차손이 재무제표에 반영됐고 모형·사업계획·가정·전문가에 대한 증거가 충분합니다. 손상차손이 크다는 이유만으로 의견을 변형해야 할까요?", choices: ["아니다. 회계처리와 공시가 적정하면 핵심감사사항으로 설명하면서 적정의견이 가능하다", "그렇다. 손상차손이 있으면 반드시 부적정의견이다", "그렇다. 손상차손이 있으면 반드시 의견거절이다"], answer: 0, explanation: "실제 별도감사보고서는 HYBE America 투자 손상을 핵심감사사항으로 다루고 적정의견을 표명했습니다.", basis: "2023 별도감사보고서 · KAM 및 감사의견", skill: "판단력" },
    ],
  ...
  },
  {
    ...
    questions: [
      { stage: "위험 평가", kicker: "IDENTIFY THE RISK", prompt: "카카오는 에스엠 지분 40.54%를 1.36조원에 취득해 지배력을 얻었고 매수가격을 인수 자산·부채에 공정가치로 배분했습니다. 가장 유의적인 감사위험은?", choices: ["식별가능 자산·부채의 공정가치와 잔여 영업권이 경영진 판단으로 왜곡될 위험", "취득대금이 전액 매출로 인식될 위험", "에스엠의 모든 자산이 현금으로 분류될 위험"], answer: 0, explanation: "취득금액의 규모와 공정가치 기반 매수가격배분에 유의적인 판단이 포함돼 사업결합 회계처리가 핵심감사사항이 됐습니다.", basis: "2023 연결감사보고서 · KAM 선정 이유", skill: "판단력" },
      { stage: "전문가 활용", kicker: "DO NOT OUTSOURCE JUDGMENT", prompt: "회사가 주요 무형자산 등의 공정가치 평가에 독립적인 외부전문가를 활용했습니다. 감사인이 전문가 보고서를 수령한 다음 가장 먼저 판단할 것은?", choices: ["전문가의 독립성과 적격성을 평가하고 사용한 방법론·가정을 별도로 검토한다", "독립적 전문가라는 명칭만 확인하고 평가값을 그대로 수용한다", "전문가가 참여했으므로 내부통제 평가는 생략한다"], answer: 0, explanation: "감사인은 경영진측 외부전문가의 독립성과 적격성을 평가하고 공정가치 방법론과 가정을 별도로 검토했습니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "공정가치", kicker: "CHALLENGE THE PPA", prompt: "식별가능 무형자산의 평가액이 제시됐습니다. 계산이 맞는지만 확인하면 충분할까요?", choices: ["아니다. 평가방법론과 주요 가정·변수의 일관성 및 합리성까지 평가해야 한다", "그렇다. 산술적으로 맞으면 공정가치는 적정하다", "그렇다. 취득대가 총액과 일치하면 각 자산의 평가는 보지 않는다"], answer: 0, explanation: "실제 감사인은 방법론의 적절성, 주요 가정·변수의 일관성과 합리성, 계산 정확성을 모두 평가했습니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "판단력" },
      { stage: "공시 판단", kicker: "CONNECT THE DISCLOSURE", prompt: "매수가격배분의 측정이 합리적이어도 사업결합 주석이 취득내역과 주요 금액을 충분히 설명하지 못한다면 감사는 끝난 것일까요?", choices: ["아니다. 사업결합 관련 연결재무제표 주석 공시의 적절성도 별도로 평가해야 한다", "그렇다. 측정만 맞으면 공시는 감사범위가 아니다", "그렇다. 핵심감사사항이면 주석은 생략할 수 있다"], answer: 0, explanation: "감사보고서는 사업결합 관련 주석 공시의 적절성 평가를 실제 대응절차로 명시합니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "효율성" },
      { stage: "보고 판단", kicker: "FORM THE OPINION", prompt: "사업결합의 통제·전문가·방법론·가정·계산·공시에 충분한 증거를 확보했습니다. 거래 규모가 매우 크다는 사실만으로 의견을 변형해야 할까요?", choices: ["아니다. 핵심감사사항으로 설명하면서 연결재무제표에 적정의견을 표명할 수 있다", "그렇다. 대규모 인수는 반드시 한정의견이다", "그렇다. 영업권이 생기면 반드시 부적정의견이다"], answer: 0, explanation: "실제 보고서는 에스엠 사업결합을 핵심감사사항으로 설명하면서 연결재무제표에 적정의견을 표명했습니다.", basis: "2023 연결감사보고서 · KAM 및 감사의견", skill: "판단력" },
    ],
  ...
  },
  {
    ...
    questions: [
      { stage: "손상징후", kicker: "READ THE SIGNALS", prompt: "LG디스플레이 투자 장부금액은 시장가치보다 유의적으로 높고 실제 성과도 이전 전망보다 악화됐습니다. 감사인이 내려야 할 우선 판단은?", choices: ["손상징후가 존재하므로 관계기업투자의 회수가능가액 검증을 유의적 위험으로 다룬다", "시장가치가 장부금액보다 낮아도 지분법 투자에는 손상검사가 불필요하다", "주가 하락분만큼 투자 장부금액을 자동으로 조정한다"], answer: 0, explanation: "두 사실은 감사보고서가 직접 밝힌 손상징후입니다. 회사는 이에 따라 손상검사를 수행했고 감사인은 이를 핵심감사사항으로 다뤘습니다.", basis: "2023 연결감사보고서 · KAM 선정 이유", skill: "판단력" },
      { stage: "감사전략", kicker: "MATCH THE RISK", prompt: "관계기업투자 장부금액이 2.65조원이고 사용가치에 미래현금흐름 판단이 포함됩니다. 가장 적절한 감사전략은?", choices: ["가치평가전문가를 참여시키고 손상 관련 통제와 사용가치 모형을 함께 검증한다", "시장 주가만 장부금액과 비교하고 절차를 종료한다", "관계기업의 현금 시재만 실사한다"], answer: 0, explanation: "실제 감사인은 가치평가전문가와 함께 회계정책·내부통제·승인통제·가치평가 모형을 평가했습니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "효율성" },
      { stage: "과거예측 검증", kicker: "LOOK BACK", prompt: "경영진이 새로운 사업계획에서 실적 회복을 전망합니다. 그 전망의 신뢰성을 판단하는 가장 직접적인 감사절차는?", choices: ["전기 손상검사에 사용된 사업계획과 이후 실제 성과를 비교한다", "새 사업계획이 이사회 자료에 포함됐는지만 본다", "경영진의 회복 설명만 확인서로 받는다"], answer: 0, explanation: "감사인은 전기 손상검사 사업계획과 LG디스플레이의 실제 사업성과를 비교해 경영진 추정의 적정성을 평가했습니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "가정 반증", kicker: "USE EXTERNAL EVIDENCE", prompt: "미래현금흐름은 승인 사업계획과 일치합니다. 그래도 할인율과 성장률을 추가로 검증해야 하는 이유와 절차는?", choices: ["내부 승인만으로 합리성이 보장되지 않으므로 동종 산업 외부지표와 역사적 재무정보에 비교한다", "승인된 계획이면 주요 가정은 감사하지 않는다", "할인율과 성장률은 회계추정이 아니므로 계산만 확인한다"], answer: 0, explanation: "감사인은 미래현금흐름과 승인 계획의 일치를 확인한 뒤에도 할인율·성장률을 외부 벤치마크와 과거 정보에 비교했습니다.", basis: "2023 연결감사보고서 · KAM 감사대응", skill: "의구심" },
      { stage: "결론 형성", kicker: "STRESS THE MODEL", prompt: "기준 가정에서는 손상이 추가로 발생하지 않습니다. 이 결론이 특정 가정에 과도하게 의존하는지 판단하려면?", choices: ["할인율과 영구성장률 변화가 손상평가에 미치는 민감도 분석을 평가한다", "기준 가정의 계산이 맞으면 즉시 적정하다고 결론낸다", "관계기업투자를 자동으로 전액 손상한다"], answer: 0, explanation: "실제 감사인은 할인율과 영구성장률 민감도 분석을 평가했고 연결재무제표에 적정의견을 표명했습니다.", basis: "2023 연결감사보고서 · KAM 및 감사의견", skill: "판단력" },
    ],
...
// Keep answer positions varied so the real-company section tests judgment, not button order.
realCases.forEach((auditCase, caseIndex) => {
  auditCase.questions.forEach((question, questionIndex) => {
    const targetIndex = (caseIndex + questionIndex) % question.choices.length;
    if (targetIndex === question.answer) return;

    const reorderedChoices = [...question.choices];
    const [correctChoice] = reorderedChoices.splice(question.answer, 1);
    reorderedChoices.splice(targetIndex, 0, correctChoice);
